...
# App Configuration
APP_PATH = str(APK_DIR) if APK_DIR.exists() else r"C:\Users\Mohsin Ali\Documents\Automation\LanguageTranslatorAutomation\Language Translator-debug.apk"
...
SPLASH_SCREEN_MIN_WAIT = 8  # Minimum wait for splash screen
